      ...
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          ...
          if (isset($_POST["submit"])) {
            if (isset($_POST["dob"]) && isset($_POST["voterID"]) && isset($_POST["selectedCandidate"])) {
          ...
          $checkVoter = "SELECT * FROM `tbl_users` WHERE voter_id = $voterID AND dob= '" . $dob . "';";
          $result = mysqli_query($conn, $checkVoter);

          if (mysqli_num_rows($result) > 0) {

            $sql = "INSERT INTO db_evoting.tbl_votes VALUES('" . $voterID . "','" . $selection . "');";
            ...
            echo "<h3 class='text-info specialHead text-center'><strong> Voter not Registered.!!</strong></h3>";
            echo "<a href='index.html' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Finish</strong> </a>";
          }
          ?>
        </div>
