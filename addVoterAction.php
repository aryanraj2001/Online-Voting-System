    ...
    <div class="container" style="padding-top:150px;">
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          ...
          // print_r($_POST);
          if (isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["voterID"]) && isset($_POST["aadhar"]) && isset($_POST["dob"])) {
            ...
            $sql = "INSERT INTO db_evoting.tbl_users VALUES(null,'" . $name . "','" . $email . "','" . $voterID . "','" . $aadhar . "','" . $dob . "');";


            if (mysqli_query($conn, $sql)) {
              echo "<img src='images/checked.png' width='70' height='70'>";
              echo "<h3 class='text-info specialHead text-center'><strong> Voter added successfully.</strong></h3>";
